...
st.markdown("<center><h3>Ingeniería en Computación Inteligente</h3>", unsafe_allow_html=True)
st.markdown("<center><h3 class='centered'>Esto es un texto en markdown</h3>", unsafe_allow_html=True)
